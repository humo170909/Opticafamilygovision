...
const btnEye   = document.getElementById('btn-toggle-pwd');
btnEye?.addEventListener('click', () => {
  const isVisible = pwdInput.type === 'text';
  pwdInput.type = isVisible ? 'password' : 'text';
  btnEye.querySelector('.eye-show').hidden =  isVisible;
  btnEye.querySelector('.eye-hide').hidden = !isVisible;
  btnEye.setAttribute('aria-label', isVisible ? 'Mostrar contraseña' : 'Ocultar contraseña');
});
